    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Machine Learning A-Z', style: Styles.textStyle30W700),
          const SizedBox(height: 8),

          Text(
            'Based on your interest in Data Science, '
            'this course is the perfect next step for your career path.',
            style: TextStyle(color: const Color(0xFF6A6984), fontSize: 15.sp),
          ),
          ...
          Center(
            child: ElevatedButton(
              ...
              onPressed: onPressed,
              child: Text('Enroll Now', style: Styles.textStyle16W600),
            ),
          ),
        ],
      ),
